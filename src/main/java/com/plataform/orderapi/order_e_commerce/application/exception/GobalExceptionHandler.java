package com.plataform.orderapi.order_e_commerce.application.exception;
...
@Component
@Slf4j
public class GobalExceptionHandler extends AbstractErrorWebExceptionHandler {


    public GobalExceptionHandler(ErrorAttributes errorAttributes, WebProperties.Resources resources, ApplicationContext applicationContext, ServerCodecConfigurer codecConfigurer) {
